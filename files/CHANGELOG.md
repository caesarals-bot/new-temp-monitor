...
> El backlog activo de tareas de estabilización pendientes (`TASK-015`) vive en `files/BACKLOG.md`. El histórico de tareas terminadas se encuentra en `files/TASKS_HISTORY.md`.
