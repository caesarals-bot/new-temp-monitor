...
**TASK-011** ✅ cerrada en la sesión siguiente. **TASK-012** (panel de platform admin, prioridad Baja) es la próxima — depende solo de TASK-005 ✅.
...
> Las tareas abiertas del backlog están en `files/BACKLOG.md` (TASK-012).
